...
import { lookFor } from '../../src/string/lookFor'


describe('string', () => {
	test('lookFor', () => {
		expect(lookFor(undefinedString, '')).toEqual(NotFound)
		expect(lookFor(undefinedString, 'a')).toEqual(NotFound)
		expect(lookFor(nullString, '')).toEqual(NotFound)
		expect(lookFor(nullString, 'a')).toEqual(NotFound)
